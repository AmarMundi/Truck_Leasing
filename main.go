...
// v1   KL 20 Jan 2016 Initial contract supporting multiple assets with load and gforce
...
func (t *SimpleChaincode) createAsset(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
    ...
    var timeOut = time.Now() // load initialization of time variable - not really needed.. keeping old line
